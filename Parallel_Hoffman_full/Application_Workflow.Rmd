...
#define tree sizes
tree_sizes_1= seq(5, 300, by=5) #this is a list of tree sizes. 
...
plot(x, ylow, type = "l", ylab = "mpd", ylim = c(10,400), xlab = "tree size", main = "95%CI of mpd compared with true fish fam values")
