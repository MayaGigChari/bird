...
CI_cali_significance_polygons_mpd_plants[sapply(CI_cali_significance_polygons_mpd_plants, is.null)] <- NA
CI_cali_significance_polygons_mntd_plants[sapply(CI_cali_significance_polygons_mntd_plants, is.null)] <- NA

CI_ecoregions_significance_polygons_pd_plants[sapply(CI_ecoregions_significance_polygons_pd_plants, is.null)] <- NA
CI_ecoregions_significance_polygons_mpd_plants[sapply(CI_ecoregions_significance_polygons_mpd_plants, is.null)] <- NA
CI_ecoregions_significance_polygons_mntd_plants[sapply(CI_ecoregions_significance_polygons_mntd_plants, is.null)] <- NA
