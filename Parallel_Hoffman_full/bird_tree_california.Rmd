...
tree_sizes= seq(10, 595, by=5) #this is a list of tree sizes. 
...
#trying to simulate pd 
tree_practice<- read.tree(file = 'sample_trees_birds/sample_tree_cluster590')

pd_random_vals<- rep(NA,1000) 
for(i in seq(1,1000))
{
  
  pd_random_vals[i]<- pd_app_picante(tree_practice, tipShuffle(cali_bird_phylo))$PD
  print(pd_random_vals[i])
}
hist(pd_random_vals)
```
