...
#$ -o joblog.$JOB_ID  #creates a file called joblog.JOB_ID to write to. 
#$ -j y 
...
# run R code
echo 'collecting randomizations and running stats' #prints this quote to joblog.jobidnumber
Rscript variable_output.R > output.$JOB_ID 
Rscript trial_add.R >output.JOB_ID.1
